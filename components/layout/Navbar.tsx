...
import { ShoppingCart, Menu, X, PhoneCall, Sparkles } from 'lucide-react';
  ...
  return (
    <header className="sticky top-0 z-50">
      <div className="bg-[#1a120b] text-white">
        <div className="max-w-7xl mx-auto px-6 py-2.5 flex items-center justify-center md:justify-between gap-3 text-center text-[10px] sm:text-xs uppercase tracking-[0.22em]">
          <span className="text-gold flex items-center gap-2">
            <Sparkles className="w-3.5 h-3.5" />
            Special Offer
          </span>
          <span>Get up to 30% off premium embroidery</span>
        </div>
      </div>
      ...
      <nav className="bg-dark-bg text-black border-b border-gold/30">
